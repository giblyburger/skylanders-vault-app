const CACHE_NAME = 'gibly-private-pairing-v1';
const ASSETS = [
  './',
  './index.html',
  './manifest.webmanifest',
  './public/manifest-ipad.webmanifest',
  './src/app.js?v=private-pairing-v1',
  ...
  './src/components/MasterCatalog.js?v=private-pairing-v1',
  './src/components/CloudSync.js?v=private-pairing-v1',
  './src/styles/gallery.css?v=private-pairing-v1',
