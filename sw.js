const CACHE_NAME = 'gibly-full-series-legacy-v1';
const ASSETS = [
  './',
  './index.html',
  './manifest.webmanifest',
  './public/manifest-ipad.webmanifest',
  './src/app.js?v=full-series-legacy-v1',
  ...
  './src/components/MasterCatalog.js?v=full-series-legacy-v1',
  './src/components/CloudSync.js?v=cloud-nfc-v1',
  './src/styles/gallery.css?v=full-series-legacy-v1',
