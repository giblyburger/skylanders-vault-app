const CORE_CACHE_NAME = 'gibly-core-display-v8';
...
const CORE_ASSETS = [
  ...
  './src/components/MasterCatalog.js?v=display-v8',
  ...
  './src/styles/theme-warm-v4.css?v=display-v8',
